...
//                    strcat( postCmd , ".pch" ) ;
        ...
        else if( !strcmp( postCmd , "2snips" ) )
        {
            ...
            system( "\\ideafarm.home.1\\ephemeral\\city\\workshop\\exe\\ideafarm.flip.ipdos < \\ideafarm.home.1\\precious\\domains\\com\\ideafarm\\city\\library\\dictionary\\1snip.1e000001.omittedWindowsHeaders > \\ideafarm.home.1\\precious\\domains\\com\\ideafarm\\city\\library\\snip\\1snip.1e000001.omittedWindowsHeaders.h" ) ;
        ...
        else if( !strcmp( postCmd , "4link" ) )
        {
            ...
            )
            {
                ...
                char* postSmudge = strstr( postCmd , "wm file" ) ;
                *postSmudge = 't' ;

                postSmudge = strstr( postCmd , "1.err" ) ;
                *postSmudge = '2' ;
            ...
            if( !bMakeElfOnly )
            {
                ...
                //#endif
                    ...
                    //if( !( flagsAll & flELVES_DEBUGiNFO ) )
                    {
                        ...
                        system( "robocopy \\ideafarm.home.1\\precious\\domains\\com\\ideafarm\\city\\workshop\\watcom\\binnt                            \\tmp\\bundle\\ideafarm.home.101\\precious\\domains\\com\\ideafarm\\city\\workshop\\watcom\\binnt                            /E /MT" ) ;  //20251221@2133: SO WELCOMER CAN RUN wrc.exe
                        system( "robocopy \\ideafarm.home.1\\precious\\domains\\com\\ideafarm\\city\\workshop\\base64encode                             \\tmp\\bundle\\ideafarm.home.101\\precious\\domains\\com\\ideafarm\\city\\workshop\\base64encode                             /E /MT" ) ;
        ...
        else if( !strcmp( postCmd , "!worker_2snips_ipdos.h" ) )
        {
            ...
            if( isStaleF( postDraft2 , "\\ideafarm.home.1\\precious\\domains\\com\\ideafarm\\city\\library\\dictionary\\1snip.*" ) )
            {
                ...
                char* ppostFrom[] =
                {
                    ...
                    "1snip.15*.jotFileBranchC"                              ,
                    "1snip.15*.jotFilesNamedC"                              ,
                    "1snip.15*.jotFileNameC"                                ,
                    "1snip.15*.jotFilesC"                                   ,
                    "1snip.15*.jotFileSoilC"                                ,
                    "1snip.15*.jotFilePartC"                                ,
                    "1snip.15*.jotFileBaseC"                                ,
                    "1snip.15*.sortaC"                                      ,
                    "1snip.15*.recursionSimulatorC"                         ,
                    "1snip.15*.echoPacketS"                                 ,
                    "1snip.15*.sorterC"                                     ,
                    ...
                    "1snip.15*.tlsStackFrame12S"                            ,
                    "1snip.15*.tlsStackFrame123S"                           ,
                    ...
                    "1snip.15*.tlsAllocStackExp_7_C"                        ,
                    "1snip.15*.tlsAllocStackExp_6_C"                        ,
                    "1snip.15*.tlsAllocStackExp_5_C"                        ,
                    "1snip.15*.tlsAllocStackExp_4_C"                        ,
                    "1snip.15*.tlsAllocStackExp_3_C"                        ,
                    "1snip.15*.tlsAllocStackExp_2_C"                        ,
                    "1snip.15*.tlsAllocStackExp_1_C"                        ,
                    "1snip.15*.tlsAllocStackExp_0_C"                        ,
...
void elf_obey_C::compileF( const char* postGroupP , int bPauseP )
{
    if( strlen( postGroupP ) == 5 )
    {
        ...
        int bThird =
            ...
            !strcmp( postGroupP , "3611a" ) ||      // eyeC  (only for debugging code in eyeC::moveF
            ...
            !strcmp( postGroupP , "36142" ) ||      // processGlobal1S CALLS GetSystemInfo
        ...
        if( bOk )
        {
            ...
            if(  bThird && !bCNotCpp              ) { FILEpILEpREFIX "1snip.1e000001.omittedWindowsHeaders"                                           )                                                                                                                           ; system( postCmd ) ; }
          ...
          //if( !strcmp( postLike , "21000" )     ) { FILEpILEpREFIX "1snip.1a000004.ifcenablethirdpartiesmultiplemonitorfake.COMPILE_MULTIMON_STUBS" )                                                                                                                           ; system( postCmd ) ; }
        }
        ...
        if( bOk )
        {
            ...
            if( oshFind != INVALID_HANDLE_VALUE )
            {
                ...
                FindClose( oshFind ) ; oshFind = INVALID_HANDLE_VALUE ;
                                               ...
                                               { char postCmd[ 0x200 ] = "\\ideafarm.home.1\\ephemeral\\city\\workshop\\exe\\ideafarm.filepile.ipdos \\ideafarm.home.1\\ephemeral\\city\\workshop\\1raw\\" ; strcat( postCmd , postRaw ) ; strcat( postCmd , " -d \\ideafarm.home.1\\precious\\domains\\com\\ideafarm\\city\\library\\dictionary\\1snip.1e000001.omittedWindowsHeaders"                    ) ; system( postCmd ) ; }
...
void elf_obey_C::linkF( char* postIdiForeignP )
{
    ...
    int bCon = postIdiForeignP == strstr( postIdiForeignP , "41000002" ) ;
    int bGui = postIdiForeignP == strstr( postIdiForeignP , "41000003" ) ;
    int bAda = postIdiForeignP == strstr( postIdiForeignP , "51000620" ) ;
        ...
        if( isStaleF( postMas , postObj ) )
        {
            ...
            if( bCon || bAda )
            {
                ...
                *postSmudge = 't' ;
                ...
                postSmudge = strstr( postCmd , "wl op heapsize=" ) ;
                *postSmudge = 't' ;

                postSmudge = strstr( postCmd , "map op mangle" ) ;
                *postSmudge = 't' ;
...
void makeFoldersCopyThirdPartyDllsF( void )
{
    ...
    CreateDirectory( "\\tmp\\bundle" , 0 ) ;
    CreateDirectory( "\\tmp\\bundle\\ideafarm.home.101" , 0 ) ;
    CreateDirectory( "\\tmp\\bundle\\ideafarm.home.101\\precious" , 0 ) ;
    CreateDirectory( "\\tmp\\bundle\\ideafarm.home.101\\precious\\domains" , 0 ) ;
    CreateDirectory( "\\tmp\\bundle\\ideafarm.home.101\\precious\\domains\\com" , 0 ) ;
    CreateDirectory( "\\tmp\\bundle\\ideafarm.home.101\\precious\\domains\\com\\ideafarm" , 0 ) ;
    CreateDirectory( "\\tmp\\bundle\\ideafarm.home.101\\precious\\domains\\com\\ideafarm\\city" , 0 ) ;
...
void tmAbortF( void* pnuP )
{
    ...
    //elfC::cElves = elfC::cElvesUncounted = 0 ; //U:: TO FIND A BUG (THIS LINE, OR SOMETHING LIKE IT, MIGHT BE NEEDED IN PRODUCTION)
