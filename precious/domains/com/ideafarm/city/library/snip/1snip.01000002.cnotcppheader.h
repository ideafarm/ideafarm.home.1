...
#define ifcIDeXCEPTIONoPENsSL_setupIF                       ((countT)0x80000001)
#define ifcIDeXCEPTIONoPENsSL_waveByeIF                     ((countT)0x80000002)
#define ifcIDeXCEPTIONoPENsSL_getContextIF                  ((countT)0x80000003)
#define ifcIDeXCEPTIONoPENsSL_getWrapperIF                  ((countT)0x80000004)
#define ifcIDeXCEPTIONoPENsSL_wrapSocketIF                  ((countT)0x80000005)
#define ifcIDeXCEPTIONoPENsSL_shakeHandsAsClientIF          ((countT)0x80000006)
#define ifcIDeXCEPTIONoPENsSL_writeIF                       ((countT)0x80000007)
#define ifcIDeXCEPTIONoPENsSL_readIF                        ((countT)0x80000008)
#define ifcIDeXCEPTIONoPENsSL_shakeHandsAsServerIF          ((countT)0x80000009)
#define ifcIDeXCEPTIONoPENsSL_peekIF                        ((countT)0x8000000a)
#define ifcIDeXCEPTIONoPENsSL_wrapperFreeIF                 ((countT)0x8000000b)
#define ifcIDeXCEPTIONoPENsSL_errorCodeIF                   ((countT)0x8000000c)
#define ifcIDeXCEPTIONoPENsSL_keyPairIF                     ((countT)0x8000000d)
#define ifcIDeXCEPTIONoPENsSL_writePrivateKeyToFileIF       ((countT)0x8000000e)
#define ifcIDeXCEPTIONoPENsSL_writePublicKeyToFileIF        ((countT)0x8000000f)
#define ifcIDeXCEPTIONoPENsSL_readPrivateKeyFromFileIF      ((countT)0x80000010)
#define ifcIDeXCEPTIONoPENsSL_readPublicKeyFromFileIF       ((countT)0x80000011)
#define ifcIDeXCEPTIONoPENsSL_encryptIF                     ((countT)0x80000012)
#define ifcIDeXCEPTIONoPENsSL_decryptIF                     ((countT)0x80000013)
#define ifcIDeXCEPTIONoPENsSL_getPublicKeyBase64IF          ((countT)0x80000014)
#define ifcIDeXCEPTIONoPENsSL_getPrivateKeyBase64IF         ((countT)0x80000015)
#define ifcIDeXCEPTIONoPENsSL_hmacIF_1                      ((countT)0x80000016)
#define ifcIDeXCEPTIONoPENsSL_hmacIF_2                      ((countT)0x80000017)
#define ifcIDeXCEPTIONoPENsSL_hmacIF_3                      ((countT)0x80000018)
...
MYpREFIX unsigned        _export __watcall c_getaddrinfoF( char* pbListP , unsigned cbListP , const char* const postNameP ) ;
...
MYpREFIX void            _export __watcall c_oldTimeFromUnixTimeIF( unsigned* pEcP , unsigned* pIsDaylightSavingsTimeP , unsigned* pYDayP , unsigned* pWDayP , unsigned* pYearP , unsigned* pMonthP , unsigned* pMDayP , unsigned* pHourP , unsigned* pMinuteP , unsigned* pSecondP , const unsigned secondsIntoUnixEpochP ) ;
    ...
    MYpREFIX void           __watcall c_openSslEncryptBase64IF(                   unsigned* pEcP                                                                                                                                                                                                                                      ) ;
#endif
